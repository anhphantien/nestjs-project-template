...
export const Column64Char = (options = { select: true }) =>
  Column({
    type: 'varchar',
    length: 64,
    nullable: true,
...
export const ColumnBoolean = (options = { default: null }) =>
  Column({
    type: 'boolean',
    nullable: true,
...
export const ColumnDecimal = (options = { precision: 255, scale: 2 }) =>
  Column({
    type: 'double',
    nullable: true,
...
export const ColumnTinyInt = (options = { default: null }) =>
  Column({
    type: 'tinyint',
    nullable: true,
    default: options.default,
...
export const ColumnUuid = (options = { select: true }) =>
  Column({
    type: 'varchar',
    generated: 'uuid',
    length: 36,
...
export const CreatedAt = (options = { select: false }) =>
  CreateDateColumn({
    type: 'datetime',
    nullable: true,
    // precision: 0, // for MariaDB
...
export const UpdatedAt = (options = { select: false }) =>
  UpdateDateColumn({
    type: 'datetime',
    nullable: true,
    // precision: 0, // for MariaDB
